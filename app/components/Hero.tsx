export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="absolute top-40 right-20 w-32 h-32 bg-purple-500 bg-opacity-20 rounded-full blur-xl animate-pulse"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="absolute bottom-20 left-1/4 w-24 h-24 bg-cyan-500 bg-opacity-20 rounded-full blur-xl animate-pulse"
        ...
        <div className="space-y-8">
          ...
          <div className="relative inline-block">
            ...
            <img
              ...
              className="relative w-40 h-40 rounded-full object-cover object-center border-4 border-white border-opacity-20 shadow-2xl"
          ...
          <div className="space-y-6">
            ...
            <p className="max-w-3xl mx-auto text-xl text-gray-300 leading-relaxed">
              ...
              web applications. I specialize in React, Next.js, and modern web
              technologies, creating digital experiences that make a difference.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            ...
            <a
              ...
              className="group px-8 py-4 bg-white bg-opacity-10 backdrop-blur-md text-white rounded-full font-semibold text-lg border border-white border-opacity-20 hover:bg-white hover:bg-opacity-20 transition-all duration-300 hover:scale-105"
            >
            ...
            <a
              href="https://github.com/Rutvi503"
              target="_blank"
              rel="noopener noreferrer"
              className="group px-8 py-4 bg-white bg-opacity-10 backdrop-blur-md text-white rounded-full font-semibold text-lg border border-white border-opacity-20 hover:bg-white hover:bg-opacity-20 transition-all duration-300 hover:scale-105"
            >
